    ...
    return (
        <>
            ...
            <div className="choice">
                <a href="#snacks" className="menu-link">Холодные закуски</a>
                <a href="#paste" className="menu-link">Паста</a>
                <a href="#salads" className="menu-link">Салаты</a>
                <a href="#soups" className="menu-link">Супы</a>
                <a href="#dishes" className="menu-link">Гарниры</a>
            </div>
            <hr id="snacks" className="line1"/>
            <div className="cards">
            ...
            <div className="AboutBox">
                <div className="mask">
                    <img src={MaskGroup} alt="about us" className="img-mask"/>
                    <div className="AboutBoxText">
                        <h2>наше кафе</h2>

                        Сеть мягких ресторанов
                        «Своя Компания»
                        в Уфе: японская, итальянская, европейская и русская домашняя кухня,
                        бизнес-ланчи. Уютный семейный ресторан с детской комнатой в центре города!
                    </div>
                    <div className="AboutBoxImgs">
                        <div className="SquareCont">
                            <div className="square">
                                <div className="squareImg1">
                                ...
                                <div className="squareText">Свежайшие продукты</div>
                            </div>
                            <div className="square">
                                <div className="squareImg1">
                        ...
                        <div className="SquareCont">
                            <div className="square">
                                ...
                                <div className="squareText">Быстрая доставка</div>
                            </div>
            ...
            <div className="info">
                <h1 className="info-h1">Для чего нужна регистрация?</h1>

                <p className="info-p">
                    Регистрация нужна для того, чтобы вы могли заказать еду на самовывоз и воспользоваться корзиной.
