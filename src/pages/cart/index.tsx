        ...
        <div>
                ...
                <Link to={"/"}>
                    <button type="button" className="CardButton">
                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.82862 13.2888L3.32764 8.78784L7.82862 4.28687" stroke="white"
                                  strokeWidth="1.00189"
                                  strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M3.95361 8.78821H13.0806" stroke="white" strokeWidth="1.00189"
                                  strokeLinecap="round"
            ...
            {cart.length !== 0 && <>
                ...
                <Center py={"sm"}>
                    ...
                    <Group ml={"sm"}>
                        {times.map((time) => (
                            <div onClick={() => setSelectedTime(time)} style={{
                                padding: 5,
                                backgroundColor: selectedTime === time ? "#56BB5B" : "#538f56",
                                color: "#FFF",
                                borderRadius: 5,
                                cursor: "pointer"
                            }}>
                ...
                <div style={{display: "flex", marginTop: "5%", justifyContent: "space-around"}}>
                    ...
                    <div style={{marginTop: '1%', display: "flex", width: "15%"}}>
                        <button style={{marginRight: "5%"}} className={'CartBtn'} onClick={() => openModal()}>Оформить
                            заказ
                        </button>
                        <button style={{backgroundColor: "#c72626"}} className={'CartBtn'} onClick={open}>Очистить
                            корзину
                        </button>
                    </div>
                </div>
